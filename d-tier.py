...
url = "https://liquipedia.net/pubgmobile/D-Tier_Tournaments"
...
# Get all the URLs present on https://liquipedia.net/pubgmobile/D-Tier_Tournaments page
for anchor in anchor_tags:
    if '/pubgmobile/D-Tier_Tournaments' in anchor["href"]:
