...
url = "https://liquipedia.net/pubgmobile/Miscellaneous_Tournaments"
...
# Get all the URLs present on https://liquipedia.net/pubgmobile/Miscellaneous_Tournaments page
for anchor in anchor_tags:
    if '/pubgmobile/Miscellaneous_Tournaments' in anchor["href"]:
...
csv_file_name = 'Miscellaneous.csv'
