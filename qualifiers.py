...
url = "https://liquipedia.net/pubgmobile/Qualifier_Tournaments"
...
# Get all the URLs present on https://liquipedia.net/pubgmobile/Qualifier_Tournaments page
for anchor in anchor_tags:
    if '/pubgmobile/Qualifier_Tournaments' in anchor["href"]:
