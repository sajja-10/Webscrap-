...
url = "https://liquipedia.net/pubgmobile/B-Tier_Tournaments"
...
# Get all the URLs present on https://liquipedia.net/pubgmobile/B-Tier_Tournaments page
for anchor in anchor_tags:
    if '/pubgmobile/B-Tier_Tournaments' in anchor["href"]:
