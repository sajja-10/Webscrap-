...
url = "https://liquipedia.net/pubgmobile/Individual_Tournaments"
...
# Get all the URLs present on https://liquipedia.net/pubgmobile/Individual_Tournaments page
for anchor in anchor_tags:
    if '/pubgmobile/Individual_Tournaments' in anchor["href"]:
...
# Field names for CSV
fieldnames = [ 'Tournament', 'Date', 'Prize', 'Location','Participants', 'Winner',  'Runner_up']
