...
url = "https://liquipedia.net/pubgmobile/Monthly_Tournaments"
...
# Get all the URLs present on https://liquipedia.net/Monthly_Tournaments/ page
for anchor in anchor_tags:
    if '/pubgmobile/Monthly_Tournaments' in anchor["href"]:
