...
url = "https://liquipedia.net/pubgmobile/A-Tier_Tournaments"
...
# Get all the URLs present on https://liquipedia.net/pubgmobile/A-Tier_Tournaments page
for anchor in anchor_tags:
    if '/pubgmobile/A-Tier_Tournaments' in anchor["href"]:
