...
url = "https://liquipedia.net/pubgmobile/C-Tier_Tournaments"
...
# Get all the URLs present on https://liquipedia.net/pubgmobile/C-Tier_Tournaments page
for anchor in anchor_tags:
    if '/pubgmobile/C-Tier_Tournaments' in anchor["href"]:
